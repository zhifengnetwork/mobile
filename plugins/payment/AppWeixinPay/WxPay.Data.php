	...
	**/
	public function ToXml()
	{
		if(!is_array($this->values) 
			|| count($this->values) <= 0)
		{
    		throw new WxAppPayException("数组数据异常！");
    	}
	...
	{	
		if(!$xml){
			throw new WxAppPayException("xml数据异常！");
		}
        //将XML转为array
        //禁止引用外部xml实体
 ...
 *
 */
class WxAppPayResults extends WxAppPayDataBase
{
	/**
	 * 
	 * 检测签名
	...
	public function CheckSign()
	{
		//fix异常
		if(!$this->IsSignSet()){
			throw new WxAppPayException("签名错误！");
		}
 ...
 *
 */
class WxAppPayNotifyReply extends  WxAppPayDataBase
{
	/**
	 * 
 ...
 *
 */
class WxAppPayOrderQuery extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayCloseOrder extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayRefund extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayRefundQuery extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayDownloadBill extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayReport extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayShortUrl extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayMicroPay extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayReverse extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayJsApiPay extends WxAppPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxAppPayBizPayUrl extends WxAppPayDataBase
{
		/**
	* 设置微信分配的公众账号ID
	* @param string $value 
