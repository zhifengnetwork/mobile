...
class Auction extends ApiBase
{
    ...
    public function auction_detail()
    {
		...
		$field = 'A.id,A.goods_id,A.activity_name,A.goods_name,A.start_price,A.start_time,A.end_time,A.payment_time,A.deposit,A.increase_price,A.auction_status,A.delay_time,A.delay_num,G.original_img';
