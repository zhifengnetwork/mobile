...
class Topic extends Base {
    ...
    public function topic(){
    	...
    	$this->assign("URL_upload", U('User/Ueditor/imageUp',array('savepath'=>'topic')));
    	$this->assign("URL_fileUp", U('User/Ueditor/fileUp',array('savepath'=>'topic')));
    	$this->assign("URL_scrawlUp", U('User/Ueditor/scrawlUp',array('savepath'=>'topic')));
    	$this->assign("URL_getRemoteImage", U('User/Ueditor/getRemoteImage',array('savepath'=>'topic')));
    	$this->assign("URL_imageManager", U('User/Ueditor/imageManager',array('savepath'=>'topic')));
    	$this->assign("URL_imageUp", U('User/Ueditor/imageUp',array('savepath'=>'topic')));
    	$this->assign("URL_getMovie", U('User/Ueditor/getMovie',array('savepath'=>'topic')));
