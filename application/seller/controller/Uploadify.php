...
class Uploadify extends Base{
    ...
    public function upload(){
        ...
        if($fileType == 'Flash'){
            $upload = U('User/Ueditor/videoUp',array('savepath'=>$path,'pictitle'=>'banner','dir'=>'video'));
            $type = 'mp4,3gp,flv,avi,wmv';
        }else{
            $upload = U('User/Ueditor/imageUp',array('savepath'=>$path,'pictitle'=>'banner','dir'=>'images'));
        ...
        $info = array(
            ...
            'title' => '',
            'upload' =>$upload,
        	'fileList'=>U('User/Uploadify/fileList',array('path'=>$path)),
